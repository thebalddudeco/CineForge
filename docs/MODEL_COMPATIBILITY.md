...
|---|---|---|---|---|
| 5.1 | Wan 2.2 I2V A14B scaled-FP8 | Official native Windows release | RTX 4070 12 GB | Native WPF interface, approved locked-brand icon, private worker transport, and validated native generation path retained. |
