...
Version 0.3.1 downloads the verified model pack from immutable Hugging Face revision `3abefe070febb87cf51e038edda29934743639fb`. The installer will not follow later changes made to the repository's `main` branch.
